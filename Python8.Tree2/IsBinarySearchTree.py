...
def check_binary_search_tree(root, left=None, right=None):
    if not root:
        return True
    ...
    return check_binary_search_tree(root.left, left, root) and check_binary_search_tree(root.right, root, right)
...
if __name__ == '__main__':
    ...
    print(check_binary_search_tree(tree.root) if isOver else False)